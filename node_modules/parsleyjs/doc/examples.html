        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            <form id="demo-form" data-parsley-validate>
              ...
              <input type="text" class="form-control" name="website" data-parsley-type="url" data-parsley-error-message="A <strong>real</strong> url pretty please" />
...
<pre><code>&lt;!-- tell Parsley to validate this form and its fields -->
&lt;form id="demo-form" data-parsley-validate>
...
&lt;/form>
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p class="argument">Sometimes, regular validators and regular Parsley validation process <strong>is not enough</strong> for your forms. <strong>See how you could leverage Parsley events</strong> to make uncredible validations!</p>
          <p><a href="examples/events.html">View example &raquo;</a></p>
       </div>
    </div>
